...
typedef struct
{
    ...
    VOS_UINT32                          bitOpCsCallLocalDeregFlag:1;      /* IMS失败时，CSFB时IMS做local detach功能开关 */
...
typedef struct
{
    ...
    VOS_UINT32                          bitOpActCause52IkedAbnormal:1;                 /* WIFI_IMSA_
PDN_ACT_RESULT_IKED_ABNORMAL  */
...
typedef struct
{
    ...
    VOS_UINT8                           ucRetryCircleFlag;     /**< 是否循环尝试: 0: 不循环; 1:循环; 2: 不循环且设置为永久禁止 s00318873 */
